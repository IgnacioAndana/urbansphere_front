      ...
      >
        <div class="p-4 sm:p-6 border-b border-slate-100 flex flex-col gap-3 sm:gap-4 shrink-0 bg-white">
          ...
          <div class="flex flex-col sm:flex-row gap-2">
            ...
            <button class="bg-[#0f172a] text-white px-4 py-2 rounded-lg text-sm font-bold flex items-center justify-center gap-2 hover:bg-[#003399] transition-colors shrink-0">
            ...
            >
              ...
              <div class="w-full sm:w-3/5 p-4 flex flex-col justify-between min-w-0">
                ...
                <div class="mt-4 flex gap-2">
                  ...
                  <button class="px-3 border border-slate-200 rounded-lg text-slate-500 hover:bg-slate-50 hover:text-red-500 transition-colors flex items-center justify-center shrink-0">
                    <Heart class="w-4 h-4" />
                  </button>
                </div>
              </div>
